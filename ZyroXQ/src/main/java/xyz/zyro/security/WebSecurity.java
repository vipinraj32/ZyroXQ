...
//	                sessionConfig.sessionCreationPolicy(SessionCreationPolicy.IF_REQUIRED))
	                .authorizeHttpRequests(auth -> auth
	                        .requestMatchers("/user/login","/user/advertiser/login","/user/signup","/user/run","/advertiser/create","/advertiser/create-campaign","/advertiser/create-story","/zyro/campaign").permitAll()
